...
public class Test09 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(koren.poisci("icon.bmp"));
        System.out.println(koren.poisci("sosolci.bmp"));
        System.out.println(koren.poisci("porocilo.txt"));
        System.out.println(koren.poisci("roman.txt"));
        System.out.println(koren.poisci("etc"));
        System.out.println(koren.poisci("sluzba"));
        System.out.println("----------");

        System.out.println(ana.poisci("zabava.bmp"));
        System.out.println(ana.poisci("etc"));
        System.out.println("----------");

        System.out.println(zasebno.poisci("vsebina.txt"));
        System.out.println(zasebno.poisci("pisemce.txt"));
        System.out.println(zasebno.poisci("ana"));
        System.out.println("----------");

        System.out.println(bojan.poisci("pisemce.txt"));
        System.out.println(bojan.poisci("porocilo.txt"));
        System.out.println("----------");

        System.out.println(sluzba.poisci("porocilo.txt"));
        System.out.println(sluzba.poisci("koren"));
